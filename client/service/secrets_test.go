...
func TestSecretsAPI_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var input args
			AssertRequestWithMockServer(t, &tt.args, http.MethodPost, "/api/2.0/secrets/put", &input, tt.response, nil, tt.wantErr, func(client DBApiClient) (interface{}, error) {
...
func TestSecretsAPI_Delete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var input args
			AssertRequestWithMockServer(t, &tt.args, http.MethodPost, "/api/2.0/secrets/delete", &input, tt.response, nil, tt.wantErr, func(client DBApiClient) (interface{}, error) {
...
func TestSecretsAPI_ListSecrets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var input args
			AssertRequestWithMockServer(t, tt.args, http.MethodGet, "/api/2.0/secrets/list?scope=my-scope", &input, tt.response, tt.want, tt.wantErr, func(client DBApiClient) (interface{}, error) {
