...
const resourceName = "account_settings_v2_setting"
...
func (r *SettingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	attrs, blocks := tfschema.ResourceStructToSchemaMap(ctx, settingsv2_tf.Setting{}, func(c tfschema.CustomizableSchema) tfschema.CustomizableSchema {
		c.AddPlanModifier(stringplanmodifier.UseStateForUnknown(), "name")
		return c
	})
	resp.Schema = schema.Schema{
		Description: "Terraform schema for Databricks account_settings_v2_setting",
		Attributes:  attrs,
		Blocks:      blocks,
	}
}
...
func (r *SettingResource) update(ctx context.Context, plan settingsv2_tf.Setting, diags *diag.Diagnostics, state *tfsdk.State) {
	...
	if err != nil {
		diags.AddError("failed to update account_settings_v2_setting", err.Error())
		return
	}
...
func (r *SettingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var plan settingsv2_tf.Setting
...
func (r *SettingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var existingState settingsv2_tf.Setting
