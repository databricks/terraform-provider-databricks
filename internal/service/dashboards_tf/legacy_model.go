...
// If the field is unknown or null, the boolean return value is false.
func (o *GenieQueryAttachment_SdkV2) GetParameters(ctx context.Context) ([]QueryAttachmentParameter_SdkV2, bool) {
...
func (o *GenieQueryAttachment_SdkV2) SetParameters(ctx context.Context, v []QueryAttachmentParameter_SdkV2) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
func (c QueryAttachmentParameter_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (a QueryAttachmentParameter_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}
...
// only implements ToObjectValue() and Type().
func (o QueryAttachmentParameter_SdkV2) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		o.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"keyword":  o.Keyword,
...
// Type implements basetypes.ObjectValuable.
func (o QueryAttachmentParameter_SdkV2) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
