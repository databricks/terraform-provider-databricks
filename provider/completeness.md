...
|                         databricks_job |           job_cluster.new_cluster.cluster_log_conf.s3.canned_acl | ❌ | ❌ | ❌ |
|                         databricks_job |          job_cluster.new_cluster.cluster_log_conf.s3.destination | ❌ | ❌ | ❌ |
|                         databricks_job |          job_cluster.new_cluster.cluster_log_conf.s3.destination | ❌ | ❌ | ❌ |
|                         databricks_job |    job_cluster.new_cluster.cluster_log_conf.s3.enable_encryption | ❌ | ❌ | ❌ |
|                         databricks_job |      job_cluster.new_cluster.cluster_log_conf.s3.encryption_type | ❌ | ❌ | ❌ |
|                         databricks_job |             job_cluster.new_cluster.cluster_log_conf.s3.endpoint | ❌ | ✅ | ❌ |
|                         databricks_job |              job_cluster.new_cluster.cluster_log_conf.s3.kms_key | ❌ | ❌ | ❌ |
|                         databricks_job |               job_cluster.new_cluster.cluster_log_conf.s3.region | ❌ | ✅ | ❌ |
...
|                         databricks_job |             job_cluster.new_cluster.init_scripts.file.canned_acl | ❌ | ❌ | ❌ |
|                         databricks_job |            job_cluster.new_cluster.init_scripts.file.destination | ❌ | ❌ | ❌ |
|                         databricks_job |            job_cluster.new_cluster.init_scripts.file.destination | ❌ | ❌ | ❌ |
|                         databricks_job |            job_cluster.new_cluster.init_scripts.file.destination | ❌ | ❌ | ❌ |
|                         databricks_job |            job_cluster.new_cluster.init_scripts.file.destination | ❌ | ❌ | ❌ |
|                         databricks_job |      job_cluster.new_cluster.init_scripts.file.enable_encryption | ❌ | ❌ | ❌ |
|                         databricks_job |        job_cluster.new_cluster.init_scripts.file.encryption_type | ❌ | ❌ | ❌ |
|                         databricks_job |               job_cluster.new_cluster.init_scripts.file.endpoint | ❌ | ✅ | ❌ |
|                         databricks_job |                job_cluster.new_cluster.init_scripts.file.kms_key | ❌ | ❌ | ❌ |
|                         databricks_job |                 job_cluster.new_cluster.init_scripts.file.region | ❌ | ✅ | ❌ |
...
|                         databricks_job |                       new_cluster.driver_node_type_id (computed) | ❌ | ❌ | ❌ |
...
|                         databricks_job |                                 schedule.pause_status (computed) | ✅ | ❌ | ✅ |
...
|                         databricks_job |                                  task.new_cluster.aws_attributes | ❌ | ✅ | ❌ |
...
|                         databricks_job |                                task.spark_submit_task.parameters | ✅ | ❌ | ✅ |
...
|                databricks_sql_endpoint |                                        enable_serverless_compute | ✅ | ❌ | ❌ |
...
|                databricks_sql_endpoint |                                                     num_clusters | ✅ | ✅ | ❌ |
|                databricks_sql_endpoint |                                           odbc_params (computed) | ✅ | ❌ | ❌ |
|                databricks_sql_endpoint |                                                 odbc_params.host | ✅ | ✅ | ❌ |
