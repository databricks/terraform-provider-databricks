...
* `aws_access_key_id` (string, optional, deprecated) - Deprecated flat AWS access key ID. Superseded by
...
* `aws_secret_access_key` (ModelProviderServiceConfigProviderSecret, optional, deprecated) - Deprecated flat AWS secret access key. Superseded by
...
* `client_id` (string, optional, deprecated) - Deprecated flat Entra client ID. Superseded by
  `entra_service_principal.client_id`. Kept for one migration cycle; the
  handler mirrors it to/from `entra_service_principal`
* `client_secret` (ModelProviderServiceConfigProviderSecret, optional, deprecated) - Deprecated flat Entra client secret. Superseded by
...
* `service_credential` (ModelProviderServiceConfigServiceCredential, optional) - Reference to a UC service credential authorizing Azure OpenAI requests. On
  ...
  workspaces; Create requests from other clouds are rejected with
  INVALID_PARAMETER_VALUE
* `tenant_id` (string, optional, deprecated) - Deprecated flat Entra tenant ID. Superseded by
