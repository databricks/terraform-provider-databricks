...
* `show_deleted` (boolean, optional) - Whether to include soft-deleted projects in the response.
...
* `default_branch` (string) - The full resource path for the default branch of the project
