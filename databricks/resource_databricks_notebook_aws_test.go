...
func TestAccAwsNotebookResource_multiple_formats(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAwsNotebookResourceDestroy,
		Steps: []resource.TestStep{
			{
				Config: testAwsNotebookResourceAllNotebookTypes(
...
func TestAccAwsNotebookResource_scalability(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				// use a dynamic configuration with the random name from above
				Config:  testAwsNotebookResourceMultipleNotebooks(pythonNotebookDataB64),
				Destroy: false,
			},
		},
	})
...
func testAwsNotebookResourceDestroy(s *terraform.State) error {
...
func testAwsNotebookResourceAllNotebookTypes(pythonContent, sqlContent, scalaContent, rContent, dbcContent, jupyterContent, htmlContent, folderPrefix string) string {
	return fmt.Sprintf(`
...
func testAwsNotebookResourceMultipleNotebooks(content string) string {
