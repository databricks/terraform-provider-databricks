...
func TestSecretScopesAPI_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var input args
			AssertRequestWithMockServer(t, &tt.args, http.MethodPost, "/api/2.0/secrets/scopes/create", &input, tt.response, http.StatusOK, nil, tt.wantErr, func(client DatabricksClient) (interface{}, error) {
...
func TestSecretScopesAPI_Delete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var input args
			AssertRequestWithMockServer(t, &tt.args, http.MethodPost, "/api/2.0/secrets/scopes/delete", &input, tt.response, http.StatusOK, nil, tt.wantErr, func(client DatabricksClient) (interface{}, error) {
