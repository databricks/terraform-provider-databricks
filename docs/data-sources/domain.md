...
## Example Usage
```hcl
data "databricks_domain" "finance" {
...
* `name` (string, required) - Full resource name of the domain. The primary identifier for this resource.
