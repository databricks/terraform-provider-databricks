...
---
# databricks_clean_room Data Source
# Datasource (Singular) Artifact

A singular datasource artifact represents a single data source that can be used within a Clean Room for secure data collaboration and analysis. 

## Example Usage
# Example: Datasource (Singular) Artifact

```hcl
data "databricks_clean_room" "example" {
  name = "claire-test-clean-room"
}
```
