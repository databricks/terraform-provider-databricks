...
---
# databricks_ai_search_endpoints Data Source
...
```hcl
data "databricks_ai_search_endpoints" "all" {}
```


## Arguments
The following arguments are supported:
* `parent` (string, required) - The Workspace that owns this collection of endpoints.
