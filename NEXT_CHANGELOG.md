...
* Mark `effective_file_event_queue` as read-only in `databricks_external_location` to prevent Terraform drift when the Unity Catalog backend returns the server-populated field.
