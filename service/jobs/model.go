...
type BaseJob struct {
	...
	CreatedTime int64 `tfsdk:"created_time"`
...
type BaseRun struct {
	...
	AttemptNumber int `tfsdk:"attempt_number"`
	...
	CleanupDuration int64 `tfsdk:"cleanup_duration"`
	...
	// field.
	ExecutionDuration int64 `tfsdk:"execution_duration"`
	...
	// `run_id`.
	NumberInJob int64 `tfsdk:"number_in_job"`
	...
	OriginalAttemptRunId int64 `tfsdk:"original_attempt_run_id"`
	// The parameters used for this run.
	OverridingParameters *RunParameters `tfsdk:"overriding_parameters"`
	// The time in milliseconds that the run has spent in the queue.
	QueueDuration int64 `tfsdk:"queue_duration"`
	...
	// finish.
	RunDuration int64 `tfsdk:"run_duration"`
	// The canonical identifier of the run. This ID is unique across all runs of
	// all jobs.
	RunId int64 `tfsdk:"run_id"`
	// An optional name for the run. The maximum length is 4096 bytes in UTF-8
	// encoding.
	RunName string `tfsdk:"run_name"`
	// The URL to the detail page of the run.
	RunPageUrl string `tfsdk:"run_page_url"`
	...
	// `run_duration` field.
	SetupDuration int64 `tfsdk:"setup_duration"`
...
type CancelAllRuns struct {
	...
	AllQueuedRuns bool `tfsdk:"all_queued_runs"`
...
type ClusterInstance struct {
	...
	// The response won’t include this field if the identifier is not
	// available yet.
	SparkContextId string `tfsdk:"spark_context_id"`
...
type CreateJob struct {
	...
	MaxConcurrentRuns int `tfsdk:"max_concurrent_runs"`
	...
	// no timeout.
	TimeoutSeconds int `tfsdk:"timeout_seconds"`
...
type DbtOutput struct {
	...
	// `artifacts_link`.
	ArtifactsHeaders map[string]string `tfsdk:"artifacts_headers"`
	...
	ArtifactsLink string `tfsdk:"artifacts_link"`
...
type DbtTask struct {
	...
	ProfilesDirectory string `tfsdk:"profiles_directory"`
	...
	ProjectDirectory string `tfsdk:"project_directory"`
...
type FileArrivalTriggerConfiguration struct {
	...
	// is 60 seconds
	MinTimeBetweenTriggersSeconds int `tfsdk:"min_time_between_triggers_seconds"`
	...
	WaitAfterLastChangeSeconds int `tfsdk:"wait_after_last_change_seconds"`
...
type ForEachTaskErrorMessageStats struct {
	...
	TerminationCategory string `tfsdk:"termination_category"`
...
type ForEachTaskTaskRunStats struct {
	...
	ActiveIterations int `tfsdk:"active_iterations"`
	// Describes the number of failed and succeeded iteration runs.
	CompletedIterations int `tfsdk:"completed_iterations"`
	// Describes the number of failed iteration runs.
	FailedIterations int `tfsdk:"failed_iterations"`
	// Describes the number of iteration runs that have been scheduled.
	ScheduledIterations int `tfsdk:"scheduled_iterations"`
	// Describes the number of succeeded iteration runs.
	SucceededIterations int `tfsdk:"succeeded_iterations"`
	// Describes the length of the list of items to iterate over.
	TotalIterations int `tfsdk:"total_iterations"`
...
type GetRunRequest struct {
	...
	IncludeHistory bool `tfsdk:"-" url:"include_history,omitempty"`
	// Whether to include resolved parameter values in the response.
	IncludeResolvedValues bool `tfsdk:"-" url:"include_resolved_values,omitempty"`
...
type GitSnapshot struct {
	...
	UsedCommit string `tfsdk:"used_commit"`
...
type GitSource struct {
	...
	GitTag string `tfsdk:"git_tag"`
	// URL of the repository to be cloned by this job.
	GitUrl string `tfsdk:"git_url"`
...
type JobEmailNotifications struct {
	...
	// run is skipped.
	NoAlertForSkippedRuns bool `tfsdk:"no_alert_for_skipped_runs"`
	...
	OnDurationWarningThresholdExceeded []string `tfsdk:"on_duration_warning_threshold_exceeded"`
	...
	// notifications are not sent.
	OnSuccess []string `tfsdk:"on_success"`
...
type JobEnvironment struct {
	...
	EnvironmentKey string `tfsdk:"environment_key"`
...
type JobNotificationSettings struct {
	...
	NoAlertForCanceledRuns bool `tfsdk:"no_alert_for_canceled_runs"`
	// If true, do not send notifications to recipients specified in
...
type JobSource struct {
	...
	ImportFromGitBranch string `tfsdk:"import_from_git_branch"`
	// Path of the job YAML file that contains the job specification.
	JobConfigPath string `tfsdk:"job_config_path"`
}
...
type ListRunsRequest struct {
	...
	ActiveOnly bool `tfsdk:"-" url:"active_only,omitempty"`
	// If completed_only is `true`, only completed runs are included in the
	// results; otherwise, lists both active and completed runs. This field
	// cannot be `true` when active_only is `true`.
	CompletedOnly bool `tfsdk:"-" url:"completed_only,omitempty"`
	// Whether to include task and cluster details in the response.
	ExpandTasks bool `tfsdk:"-" url:"expand_tasks,omitempty"`
	// The job for which to list runs. If omitted, the Jobs service lists runs
	// from all jobs.
	JobId int64 `tfsdk:"-" url:"job_id,omitempty"`
	...
	// by a time range.
	StartTimeFrom int64 `tfsdk:"-" url:"start_time_from,omitempty"`
	...
	StartTimeTo int64 `tfsdk:"-" url:"start_time_to,omitempty"`
...
type NotebookTask struct {
	...
	BaseParameters map[string]string `tfsdk:"base_parameters"`
	...
	NotebookPath string `tfsdk:"notebook_path"`
...
type PythonWheelTask struct {
	...
	EntryPoint string `tfsdk:"entry_point"`
	// Command-line parameters passed to Python wheel task in the form of
	// `["--name=task", "--data=dbfs:/path/to/data.json"]`. Leave it empty if
	// `parameters` is not null.
	NamedParameters map[string]string `tfsdk:"named_parameters"`
	// Name of the package to execute
	PackageName string `tfsdk:"package_name"`
...
type RepairHistoryItem struct {
	...
	// item.
	TaskRunIds []int64 `tfsdk:"task_run_ids"`
...
type RepairRun struct {
	...
	// run"]`
	DbtCommands []string `tfsdk:"dbt_commands"`
	...
	JarParams []string `tfsdk:"jar_params"`
	// Job-level parameters used in the run. for example `"param":
	// "overriding_val"`
	JobParameters map[string]string `tfsdk:"job_parameters"`
	...
	LatestRepairId int64 `tfsdk:"latest_repair_id"`
	...
	NotebookParams map[string]string `tfsdk:"notebook_params"`

	PipelineParams *PipelineParams `tfsdk:"pipeline_params"`

	PythonNamedParams map[string]string `tfsdk:"python_named_params"`
	...
	//
	// [Task parameter variables]: https://docs.databricks.com/jobs.html#parameter-variables
	PythonParams []string `tfsdk:"python_params"`
	// If true, repair all failed tasks. Only one of `rerun_tasks` or
	// `rerun_all_failed_tasks` can be used.
	RerunAllFailedTasks bool `tfsdk:"rerun_all_failed_tasks"`
	...
	RerunDependentTasks bool `tfsdk:"rerun_dependent_tasks"`
	// The task keys of the task runs to repair.
	RerunTasks []string `tfsdk:"rerun_tasks"`
...
type RepairRunResponse struct {
	...
	RepairId int64 `tfsdk:"repair_id"`
...
type RunNow struct {
	...
	IdempotencyToken string `tfsdk:"idempotency_token"`
	// A list of parameters for jobs with Spark JAR tasks, for example
	// `"jar_params": ["john doe", "35"]`. The parameters are used to invoke the
	// main function of the main class specified in the Spark JAR task. If not
	// specified upon `run-now`, it defaults to an empty list. jar_params cannot
...
type RunOutput struct {
	...
	ErrorTrace string `tfsdk:"error_trace"`

	Info string `tfsdk:"info"`
	...
	LogsTruncated bool `tfsdk:"logs_truncated"`
...
type RunState struct {
	...
	QueueReason string `tfsdk:"queue_reason"`
	...
	UserCancelledOrTimedout bool `tfsdk:"user_cancelled_or_timedout"`
...
type SparkJarTask struct {
	...
	MainClassName string `tfsdk:"main_class_name"`
...
type SparkPythonTask struct {
	...
	// This field is required.
	PythonFile string `tfsdk:"python_file"`
...
type SqlAlertOutput struct {
	...
	OutputLink string `tfsdk:"output_link"`
...
type SqlDashboardWidgetOutput struct {
	...
	WidgetId string `tfsdk:"widget_id"`
	// The title of the SQL widget.
	WidgetTitle string `tfsdk:"widget_title"`
...
type SqlQueryOutput struct {
	EndpointId string `tfsdk:"endpoint_id"`
	// The link to find the output results.
	OutputLink string `tfsdk:"output_link"`
...
type SqlStatementOutput struct {
	...
	LookupKey string `tfsdk:"lookup_key"`
...
type SqlTaskAlert struct {
	...
	AlertId string `tfsdk:"alert_id"`
	// If true, the alert notifications are not sent to subscribers.
	PauseSubscriptions bool `tfsdk:"pause_subscriptions"`
...
type SqlTaskDashboard struct {
	...
	CustomSubject string `tfsdk:"custom_subject"`
...
type SqlTaskSubscription struct {
	...
	// notifications.
	DestinationId string `tfsdk:"destination_id"`
...
type TableUpdateTriggerConfiguration struct {
	...
	TableNames []string `tfsdk:"table_names"`
...
type Task struct {
	...
	DisableAutoOptimization bool `tfsdk:"disable_auto_optimization"`
	...
	MinRetryIntervalMillis int `tfsdk:"min_retry_interval_millis"`
	// If new_cluster, a description of a new cluster that is created for each
	// run.
	NewCluster *compute.ClusterSpec `tfsdk:"new_cluster"`
	// If notebook_task, indicates that this task must run a notebook. This
	...
	RetryOnTimeout bool `tfsdk:"retry_on_timeout"`
...
type TaskNotificationSettings struct {
	...
	AlertOnLastAttempt bool `tfsdk:"alert_on_last_attempt"`
	// If true, do not send notifications to recipients specified in
	// `on_failure` if the run is canceled.
	NoAlertForCanceledRuns bool `tfsdk:"no_alert_for_canceled_runs"`
	// If true, do not send notifications to recipients specified in
...
type UpdateJob struct {
	...
	// field is optional.
	FieldsToRemove []string `tfsdk:"fields_to_remove"`
