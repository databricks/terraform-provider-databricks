...
const resourceName = "account_iam_user_v2"
...
func (r *UserResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	...
	resp.Schema = schema.Schema{
		Description: "Terraform schema for Databricks account_iam_user_v2",
		Attributes:  attrs,
		Blocks:      blocks,
	}
}
...
func (r *UserResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	createRequest := iamv2.CreateUserRequest{
		User: user,
	}
	...
	response, err := client.IamV2.CreateUser(ctx, createRequest)
	if err != nil {
		resp.Diagnostics.AddError("failed to create account_iam_user_v2", err.Error())
		return
	}
...
func (r *UserResource) update(ctx context.Context, plan User, diags *diag.Diagnostics, state *tfsdk.State) {
	...
	updateRequest := iamv2.UpdateUserRequest{
		User:       user,
	...
	response, err := client.IamV2.UpdateUser(ctx, updateRequest)
	if err != nil {
		diags.AddError("failed to update account_iam_user_v2", err.Error())
		return
	}
...
func (r *UserResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	var deleteRequest iamv2.DeleteUserRequest
	...
	err := client.IamV2.DeleteUser(ctx, deleteRequest)
	if !declarative.IsDeleteError(err) {
		err = nil
	}
	if err != nil && !apierr.IsMissing(err) {
		resp.Diagnostics.AddError("failed to delete account_iam_user_v2", err.Error())
		return
	}
