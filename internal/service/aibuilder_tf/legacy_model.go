...
func (newState *CustomLlm_SdkV2) SyncEffectiveFieldsDuringCreateOrUpdate(plan CustomLlm_SdkV2) {
}

func (newState *CustomLlm_SdkV2) SyncEffectiveFieldsDuringRead(existingState CustomLlm_SdkV2) {
}
