...
---
# databricks_ai_gateway_model_provider_services Data Source
...
```hcl
data "databricks_ai_gateway_model_provider_services" "all" {
  parent = "schemas/main.default"
}

output "model_provider_services" {
  value = data.databricks_ai_gateway_model_provider_services.all.model_provider_services
}
```
...
* `view` (string, optional) - Fields to return for each service. `FULL` includes resolved
