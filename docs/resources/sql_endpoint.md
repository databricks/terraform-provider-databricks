...
- `instance_profile_arn` - The ARN of the instance profile to use for the endpoint. 
...
- [databricks_permissions](permissions.md#Job-Endpoint-usage) can control which groups or individual users can _Can Use_ or _Can Manage_ SQL warehouses.
