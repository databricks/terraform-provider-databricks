...
func (to *GetLoggedModelsRequest) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from GetLoggedModelsRequest) {
...
func (to *GetLoggedModelsRequest) SyncFieldsDuringRead(ctx context.Context, from GetLoggedModelsRequest) {
	if !from.ModelIds.IsNull() && !from.ModelIds.IsUnknown() && to.ModelIds.IsNull() && len(from.ModelIds.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for ModelIds, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (m GetLoggedModelsRequest) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m GetLoggedModelsRequest) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
...
// only implements ToObjectValue() and Type().
func (m GetLoggedModelsRequest) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m GetLoggedModelsRequest) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
...
// a slice of types.String values.
// If the field is unknown or null, the boolean return value is false.
func (m *GetLoggedModelsRequest) GetModelIds(ctx context.Context) ([]types.String, bool) {
...
func (m *GetLoggedModelsRequest) SetModelIds(ctx context.Context, v []types.String) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e)
	}
...
func (to *GetLoggedModelsRequestResponse) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from GetLoggedModelsRequestResponse) {
	if !from.Models.IsNull() && !from.Models.IsUnknown() && to.Models.IsNull() && len(from.Models.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for Models, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (to *GetLoggedModelsRequestResponse) SyncFieldsDuringRead(ctx context.Context, from GetLoggedModelsRequestResponse) {
	if !from.Models.IsNull() && !from.Models.IsUnknown() && to.Models.IsNull() && len(from.Models.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for Models, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (m GetLoggedModelsRequestResponse) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["models"] = attrs["models"].SetOptional()
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m GetLoggedModelsRequestResponse) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
...
// only implements ToObjectValue() and Type().
func (m GetLoggedModelsRequestResponse) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"models": m.Models,
...
// Type implements basetypes.ObjectValuable.
func (m GetLoggedModelsRequestResponse) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"models": basetypes.ListType{
...
// If the field is unknown or null, the boolean return value is false.
func (m *GetLoggedModelsRequestResponse) GetModels(ctx context.Context) ([]LoggedModel, bool) {
	if m.Models.IsNull() || m.Models.IsUnknown() {
		return nil, false
	}
	var v []LoggedModel
...
func (m *GetLoggedModelsRequestResponse) SetModels(ctx context.Context, v []LoggedModel) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
