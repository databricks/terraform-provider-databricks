...
type AwsKeyInfo struct {
	...
	KeyAlias string `tfsdk:"key_alias"`
	// The AWS KMS key's Amazon Resource Name (ARN).
	KeyArn string `tfsdk:"key_arn"`
	// The AWS KMS key region.
	KeyRegion string `tfsdk:"key_region"`
	...
	ReuseKeyForClusterVolumes bool `tfsdk:"reuse_key_for_cluster_volumes"`
...
type CreateCredentialRequest struct {
	...
	CredentialsName string `tfsdk:"credentials_name"`
}
...
type CreateGcpKeyInfo struct {
	...
	KmsKeyId string `tfsdk:"kms_key_id"`
}
...
type CreateNetworkRequest struct {
	...
	NetworkName string `tfsdk:"network_name"`
	...
	SecurityGroupIds []string `tfsdk:"security_group_ids"`
...
type CreateStorageConfigurationRequest struct {
	...
	StorageConfigurationName string `tfsdk:"storage_configuration_name"`
}

type CreateVpcEndpointRequest struct {
	// The ID of the VPC endpoint object in AWS.
	AwsVpcEndpointId string `tfsdk:"aws_vpc_endpoint_id"`
	...
	// The human-readable name of the storage configuration.
	VpcEndpointName string `tfsdk:"vpc_endpoint_name"`
...
type CreateWorkspaceRequest struct {
	...
	DeploymentName string `tfsdk:"deployment_name"`
	...
	ManagedServicesCustomerManagedKeyId string `tfsdk:"managed_services_customer_managed_key_id"`
	...
	PrivateAccessSettingsId string `tfsdk:"private_access_settings_id"`
	...
	StorageCustomerManagedKeyId string `tfsdk:"storage_customer_managed_key_id"`
	// The workspace's human-readable name.
	WorkspaceName string `tfsdk:"workspace_name"`
...
type CustomerManagedKey struct {
	...
	CustomerManagedKeyId string `tfsdk:"customer_managed_key_id"`
...
type DeleteCredentialRequest struct {
	...
	CredentialsId string `tfsdk:"-" url:"-"`
}

// Delete encryption key configuration
type DeleteEncryptionKeyRequest struct {
	// Databricks encryption key configuration ID.
	CustomerManagedKeyId string `tfsdk:"-" url:"-"`
}

// Delete a network configuration
type DeleteNetworkRequest struct {
	// Databricks Account API network configuration ID.
	NetworkId string `tfsdk:"-" url:"-"`
}

// Delete a private access settings object
type DeletePrivateAccesRequest struct {
	// Databricks Account API private access settings ID.
	PrivateAccessSettingsId string `tfsdk:"-" url:"-"`
}
...
type DeleteStorageRequest struct {
	...
	StorageConfigurationId string `tfsdk:"-" url:"-"`
}

// Delete VPC endpoint configuration
type DeleteVpcEndpointRequest struct {
	// Databricks VPC endpoint ID.
	VpcEndpointId string `tfsdk:"-" url:"-"`
}
...
type GcpNetworkInfo struct {
	...
	NetworkProjectId string `tfsdk:"network_project_id"`
	...
	PodIpRangeName string `tfsdk:"pod_ip_range_name"`
...
type GcpVpcEndpointInfo struct {
	...
	EndpointRegion string `tfsdk:"endpoint_region"`
	// The Google Cloud project ID of the VPC network where the PSC connection
	// resides.
	ProjectId string `tfsdk:"project_id"`
	// The unique ID of this PSC connection.
	PscConnectionId string `tfsdk:"psc_connection_id"`
	// The name of the PSC endpoint in the Google Cloud project.
	PscEndpointName string `tfsdk:"psc_endpoint_name"`
	// The service attachment this PSC connection connects to.
	ServiceAttachmentId string `tfsdk:"service_attachment_id"`
...
type GkeConfig struct {
	...
	MasterIpRange string `tfsdk:"master_ip_range"`
...
type NetworkVpcEndpoints struct {
	...
	DataplaneRelay []string `tfsdk:"dataplane_relay"`
	// The VPC endpoint ID used by this network to access the Databricks REST
	// API.
	RestApi []string `tfsdk:"rest_api"`
}

type NetworkWarning struct {
	// Details of the warning.
	WarningMessage string `tfsdk:"warning_message"`
...
type PrivateAccessSettings struct {
	...
	AllowedVpcEndpointIds []string `tfsdk:"allowed_vpc_endpoint_ids"`
	...
	PrivateAccessSettingsName string `tfsdk:"private_access_settings_name"`
	...
	// enabled.
	PublicAccessEnabled bool `tfsdk:"public_access_enabled"`
...
type VpcEndpoint struct {
	...
	// [endpoint service]: https://docs.aws.amazon.com/vpc/latest/privatelink/endpoint-service.html
	AwsEndpointServiceId string `tfsdk:"aws_endpoint_service_id"`
	// The ID of the VPC endpoint object in AWS.
	AwsVpcEndpointId string `tfsdk:"aws_vpc_endpoint_id"`
	// The Google Cloud specific information for this Private Service Connect
	// endpoint.
	...
	VpcEndpointId string `tfsdk:"vpc_endpoint_id"`
	// The human-readable name of the storage configuration.
	VpcEndpointName string `tfsdk:"vpc_endpoint_name"`
...
type Workspace struct {
	...
	WorkspaceStatusMessage string `tfsdk:"workspace_status_message"`
