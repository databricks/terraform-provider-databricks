...
## Example Usage
```hcl
data "databricks_workspace_entity_tag_assignments" "notebook_tags" {
...
* `entity_type` (string) - The type of entity to which the tag is assigned. Allowed values are apps, dashboards, designerfiles, geniespaces, notebooks
