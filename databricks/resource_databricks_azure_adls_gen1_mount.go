...
func resourceAzureAdlsGen1MountEntity() Mount {
	return new(AzureADLSGen1Mount)
}
...
func resourceAzureAdlsGen1Mount() *schema.Resource {
	...
	resource.Create = mountCreate(resourceAzureAdlsGen1MountEntity, resource)
	resource.Read = mountRead(resourceAzureAdlsGen1MountEntity, resource)
	resource.Delete = mountDelete(resourceAzureAdlsGen1MountEntity, resource)
	return resource
}
