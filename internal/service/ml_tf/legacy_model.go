...
func (to *GetLoggedModelsRequest_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from GetLoggedModelsRequest_SdkV2) {
	if !from.ModelIds.IsNull() && !from.ModelIds.IsUnknown() && to.ModelIds.IsNull() && len(from.ModelIds.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for ModelIds, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
		to.ModelIds = from.ModelIds
	}
}

func (to *GetLoggedModelsRequest_SdkV2) SyncFieldsDuringRead(ctx context.Context, from GetLoggedModelsRequest_SdkV2) {
	if !from.ModelIds.IsNull() && !from.ModelIds.IsUnknown() && to.ModelIds.IsNull() && len(from.ModelIds.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for ModelIds, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (m GetLoggedModelsRequest_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["model_ids"] = attrs["model_ids"].SetOptional()
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m GetLoggedModelsRequest_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
...
// only implements ToObjectValue() and Type().
func (m GetLoggedModelsRequest_SdkV2) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m GetLoggedModelsRequest_SdkV2) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
...
// a slice of types.String values.
// If the field is unknown or null, the boolean return value is false.
func (m *GetLoggedModelsRequest_SdkV2) GetModelIds(ctx context.Context) ([]types.String, bool) {
	if m.ModelIds.IsNull() || m.ModelIds.IsUnknown() {
		return nil, false
	}
	var v []types.String
	d := m.ModelIds.ElementsAs(ctx, &v, true)
	if d.HasError() {
		panic(pluginfwcommon.DiagToString(d))
	}
	return v, true
...
func (m *GetLoggedModelsRequest_SdkV2) SetModelIds(ctx context.Context, v []types.String) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e)
	}
	t := m.Type(ctx).(basetypes.ObjectType).AttrTypes["model_ids"]
	t = t.(attr.TypeWithElementType).ElementType()
	m.ModelIds = types.ListValueMust(t, vs)
}
...
func (to *GetLoggedModelsRequestResponse_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from GetLoggedModelsRequestResponse_SdkV2) {
	if !from.Models.IsNull() && !from.Models.IsUnknown() && to.Models.IsNull() && len(from.Models.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for Models, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (to *GetLoggedModelsRequestResponse_SdkV2) SyncFieldsDuringRead(ctx context.Context, from GetLoggedModelsRequestResponse_SdkV2) {
	if !from.Models.IsNull() && !from.Models.IsUnknown() && to.Models.IsNull() && len(from.Models.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for Models, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (m GetLoggedModelsRequestResponse_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["models"] = attrs["models"].SetOptional()
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m GetLoggedModelsRequestResponse_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
...
// only implements ToObjectValue() and Type().
func (m GetLoggedModelsRequestResponse_SdkV2) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"models": m.Models,
...
// Type implements basetypes.ObjectValuable.
func (m GetLoggedModelsRequestResponse_SdkV2) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"models": basetypes.ListType{
				ElemType: LoggedModel_SdkV2{}.Type(ctx),
...
// If the field is unknown or null, the boolean return value is false.
func (m *GetLoggedModelsRequestResponse_SdkV2) GetModels(ctx context.Context) ([]LoggedModel_SdkV2, bool) {
	if m.Models.IsNull() || m.Models.IsUnknown() {
		return nil, false
	}
	var v []LoggedModel_SdkV2
...
func (m *GetLoggedModelsRequestResponse_SdkV2) SetModels(ctx context.Context, v []LoggedModel_SdkV2) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
