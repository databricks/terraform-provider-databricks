...
package account_iam_external_service_principal_v2
...
const dataSourceName = "account_iam_external_service_principal_v2"
...
func (r *ExternalServicePrincipalDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var readRequest iamv2.GetExternalServicePrincipalRequest
	...
	response, err := client.IamV2.GetExternalServicePrincipal(ctx, readRequest)
	if err != nil {
		resp.Diagnostics.AddError("failed to get account_iam_external_service_principal_v2", err.Error())
		return
	}
