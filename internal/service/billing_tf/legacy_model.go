...
func (m AlertConfiguration_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"principal_overrides":   reflect.TypeOf(PrincipalOverride_SdkV2{}),
	}
}
	...
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"principal_overrides": basetypes.ListType{
				ElemType: PrincipalOverride_SdkV2{}.Type(ctx),
			},
...
// GetPrincipalOverrides returns the value of the PrincipalOverrides field in AlertConfiguration_SdkV2 as
// a slice of PrincipalOverride_SdkV2 values.
// If the field is unknown or null, the boolean return value is false.
func (m *AlertConfiguration_SdkV2) GetPrincipalOverrides(ctx context.Context) ([]PrincipalOverride_SdkV2, bool) {
	if m.PrincipalOverrides.IsNull() || m.PrincipalOverrides.IsUnknown() {
		return nil, false
	}
	var v []PrincipalOverride_SdkV2
...
// SetPrincipalOverrides sets the value of the PrincipalOverrides field in AlertConfiguration_SdkV2.
func (m *AlertConfiguration_SdkV2) SetPrincipalOverrides(ctx context.Context, v []PrincipalOverride_SdkV2) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
// GetPrincipalOverrides returns the value of the PrincipalOverrides field in CreateBudgetConfigurationBudgetAlertConfigurations_SdkV2 as
// a slice of PrincipalOverride_SdkV2 values.
// If the field is unknown or null, the boolean return value is false.
func (m *CreateBudgetConfigurationBudgetAlertConfigurations_SdkV2) GetPrincipalOverrides(ctx context.Context) ([]PrincipalOverride_SdkV2, bool) {
	if m.PrincipalOverrides.IsNull() || m.PrincipalOverrides.IsUnknown() {
		return nil, false
	}
	var v []PrincipalOverride_SdkV2
...
// SetPrincipalOverrides sets the value of the PrincipalOverrides field in CreateBudgetConfigurationBudgetAlertConfigurations_SdkV2.
func (m *CreateBudgetConfigurationBudgetAlertConfigurations_SdkV2) SetPrincipalOverrides(ctx context.Context, v []PrincipalOverride_SdkV2) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
type PrincipalOverride_SdkV2 struct {
...
func (to *PrincipalOverride_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from PrincipalOverride_SdkV2) {
}

func (to *PrincipalOverride_SdkV2) SyncFieldsDuringRead(ctx context.Context, from PrincipalOverride_SdkV2) {
}

func (m PrincipalOverride_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m PrincipalOverride_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, PrincipalOverride_SdkV2
// only implements ToObjectValue() and Type().
func (m PrincipalOverride_SdkV2) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m PrincipalOverride_SdkV2) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
