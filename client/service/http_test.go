...
func ForceErrorServer(t *testing.T, response string, responseStatus int, apiCall func(client DatabricksClient) (interface{}, error)) (interface{}, error) {
...
func TestClient_HandleErrors(t *testing.T) {
	tests := []struct {
		...
		apiCall            func(client DatabricksClient) (interface{}, error)
	}{
		{
			name: "Status 404",
			response: `{
