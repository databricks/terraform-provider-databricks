...
---
# databricks_supervisor_agents Data Source
...
* `page_size` (integer, optional) - The maximum number of supervisor agents to return.
...
## Attributes
This data source exports a single attribute, `supervisor_agents`. It is a list of resources, each with the following attributes:
