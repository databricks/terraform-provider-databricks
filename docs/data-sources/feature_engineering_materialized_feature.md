...
* `materialized_feature_id` (string, required) - Server-assigned unique identifier for the materialized feature
...
### CronSchedule
* `cron_expression` (string) - The cron expression defining the schedule (e.g., "0 0 * * *" for daily at midnight)
