...
type AlertConfiguration struct {
	...
	PrincipalOverrides types.List `tfsdk:"principal_overrides"`
...
func (to *AlertConfiguration) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from AlertConfiguration) {
	...
	if !from.PrincipalOverrides.IsNull() && !from.PrincipalOverrides.IsUnknown() && to.PrincipalOverrides.IsNull() && len(from.PrincipalOverrides.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for PrincipalOverrides, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
		to.PrincipalOverrides = from.PrincipalOverrides
	}
	if !from.PrincipalOverrides.IsNull() && !from.PrincipalOverrides.IsUnknown() {
		if toPrincipalOverrides, ok := to.GetPrincipalOverrides(ctx); ok {
			if fromPrincipalOverrides, ok := from.GetPrincipalOverrides(ctx); ok {
				// Recursively sync the fields of each PrincipalOverrides element by position.
				for i := range toPrincipalOverrides {
					if i < len(fromPrincipalOverrides) {
						toPrincipalOverrides[i].SyncFieldsDuringCreateOrUpdate(ctx, fromPrincipalOverrides[i])
					}
				}
				to.SetPrincipalOverrides(ctx, toPrincipalOverrides)
			}
		}
	}
}
	...
	if !from.PrincipalOverrides.IsNull() && !from.PrincipalOverrides.IsUnknown() {
		if toPrincipalOverrides, ok := to.GetPrincipalOverrides(ctx); ok {
			if fromPrincipalOverrides, ok := from.GetPrincipalOverrides(ctx); ok {
				for i := range toPrincipalOverrides {
					if i < len(fromPrincipalOverrides) {
						toPrincipalOverrides[i].SyncFieldsDuringRead(ctx, fromPrincipalOverrides[i])
					}
				}
				to.SetPrincipalOverrides(ctx, toPrincipalOverrides)
			}
...
func (m AlertConfiguration) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"principal_overrides":   reflect.TypeOf(PrincipalOverride{}),
	}
}
...
func (m AlertConfiguration) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		...
		map[string]attr.Value{
			...
			"principal_overrides":    m.PrincipalOverrides,
...
func (m AlertConfiguration) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"principal_overrides": basetypes.ListType{
				ElemType: PrincipalOverride{}.Type(ctx),
			},
...
// GetPrincipalOverrides returns the value of the PrincipalOverrides field in AlertConfiguration as
// a slice of PrincipalOverride values.
// If the field is unknown or null, the boolean return value is false.
func (m *AlertConfiguration) GetPrincipalOverrides(ctx context.Context) ([]PrincipalOverride, bool) {
	if m.PrincipalOverrides.IsNull() || m.PrincipalOverrides.IsUnknown() {
		return nil, false
	}
	var v []PrincipalOverride
	d := m.PrincipalOverrides.ElementsAs(ctx, &v, true)
	if d.HasError() {
		panic(pluginfwcommon.DiagToString(d))
	}
	return v, true
...
// SetPrincipalOverrides sets the value of the PrincipalOverrides field in AlertConfiguration.
func (m *AlertConfiguration) SetPrincipalOverrides(ctx context.Context, v []PrincipalOverride) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
	t := m.Type(ctx).(basetypes.ObjectType).AttrTypes["principal_overrides"]
	t = t.(attr.TypeWithElementType).ElementType()
	m.PrincipalOverrides = types.ListValueMust(t, vs)
}
...
// GetPrincipalOverrides returns the value of the PrincipalOverrides field in CreateBudgetConfigurationBudgetAlertConfigurations as
// a slice of PrincipalOverride values.
// If the field is unknown or null, the boolean return value is false.
func (m *CreateBudgetConfigurationBudgetAlertConfigurations) GetPrincipalOverrides(ctx context.Context) ([]PrincipalOverride, bool) {
	if m.PrincipalOverrides.IsNull() || m.PrincipalOverrides.IsUnknown() {
		return nil, false
	}
	var v []PrincipalOverride
...
// SetPrincipalOverrides sets the value of the PrincipalOverrides field in CreateBudgetConfigurationBudgetAlertConfigurations.
func (m *CreateBudgetConfigurationBudgetAlertConfigurations) SetPrincipalOverrides(ctx context.Context, v []PrincipalOverride) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
type PrincipalOverride struct {
	...
	// this principal.
	OverrideThreshold types.String `tfsdk:"override_threshold"`
	// Account-level principal id (user, group, or service principal).
	PrincipalId types.Int64 `tfsdk:"principal_id"`
}

func (to *PrincipalOverride) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from PrincipalOverride) {
}

func (to *PrincipalOverride) SyncFieldsDuringRead(ctx context.Context, from PrincipalOverride) {
}

func (m PrincipalOverride) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["override_threshold"] = attrs["override_threshold"].SetOptional()
	attrs["principal_id"] = attrs["principal_id"].SetOptional()

	return attrs
}

// GetComplexFieldTypes returns a map of the types of elements in complex fields in PrincipalOverride.
// Container types (types.Map, types.List, types.Set) and object types (types.Object) do not carry
// the type information of their elements in the Go type system. This function provides a way to
// retrieve the type information of the elements in complex fields at runtime. The values of the map
// are the reflected types of the contained elements. They must be either primitive values from the
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m PrincipalOverride) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, PrincipalOverride
// only implements ToObjectValue() and Type().
func (m PrincipalOverride) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"override_threshold": m.OverrideThreshold,
			"principal_id":       m.PrincipalId,
		})
}

// Type implements basetypes.ObjectValuable.
func (m PrincipalOverride) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"override_threshold": types.StringType,
