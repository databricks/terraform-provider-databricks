...
func (to *DatabaseInstance_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from DatabaseInstance_SdkV2) {
	...
	if !from.ChildInstanceRefs.IsNull() && !from.ChildInstanceRefs.IsUnknown() {
		if toChildInstanceRefs, ok := to.GetChildInstanceRefs(ctx); ok {
			if fromChildInstanceRefs, ok := from.GetChildInstanceRefs(ctx); ok {
				// Recursively sync the fields of each ChildInstanceRefs element by position.
				for i := range toChildInstanceRefs {
					if i < len(fromChildInstanceRefs) {
						toChildInstanceRefs[i].SyncFieldsDuringCreateOrUpdate(ctx, fromChildInstanceRefs[i])
					}
				}
				to.SetChildInstanceRefs(ctx, toChildInstanceRefs)
			}
		}
	}
	...
	if !from.EffectiveCustomTags.IsNull() && !from.EffectiveCustomTags.IsUnknown() {
		if toEffectiveCustomTags, ok := to.GetEffectiveCustomTags(ctx); ok {
			if fromEffectiveCustomTags, ok := from.GetEffectiveCustomTags(ctx); ok {
				// Recursively sync the fields of each EffectiveCustomTags element by position.
				for i := range toEffectiveCustomTags {
					if i < len(fromEffectiveCustomTags) {
						toEffectiveCustomTags[i].SyncFieldsDuringCreateOrUpdate(ctx, fromEffectiveCustomTags[i])
					}
				}
				to.SetEffectiveCustomTags(ctx, toEffectiveCustomTags)
			}
		}
	}
	...
	if !from.ChildInstanceRefs.IsNull() && !from.ChildInstanceRefs.IsUnknown() {
		if toChildInstanceRefs, ok := to.GetChildInstanceRefs(ctx); ok {
			if fromChildInstanceRefs, ok := from.GetChildInstanceRefs(ctx); ok {
				for i := range toChildInstanceRefs {
					if i < len(fromChildInstanceRefs) {
						toChildInstanceRefs[i].SyncFieldsDuringRead(ctx, fromChildInstanceRefs[i])
					}
				}
				to.SetChildInstanceRefs(ctx, toChildInstanceRefs)
			}
	...
	if !from.EffectiveCustomTags.IsNull() && !from.EffectiveCustomTags.IsUnknown() {
		if toEffectiveCustomTags, ok := to.GetEffectiveCustomTags(ctx); ok {
			if fromEffectiveCustomTags, ok := from.GetEffectiveCustomTags(ctx); ok {
				for i := range toEffectiveCustomTags {
					if i < len(fromEffectiveCustomTags) {
						toEffectiveCustomTags[i].SyncFieldsDuringRead(ctx, fromEffectiveCustomTags[i])
					}
				}
				to.SetEffectiveCustomTags(ctx, toEffectiveCustomTags)
			}
...
func (to *ListDatabaseCatalogsResponse_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from ListDatabaseCatalogsResponse_SdkV2) {
	...
	if !from.DatabaseCatalogs.IsNull() && !from.DatabaseCatalogs.IsUnknown() {
		if toDatabaseCatalogs, ok := to.GetDatabaseCatalogs(ctx); ok {
			if fromDatabaseCatalogs, ok := from.GetDatabaseCatalogs(ctx); ok {
				// Recursively sync the fields of each DatabaseCatalogs element by position.
				for i := range toDatabaseCatalogs {
					if i < len(fromDatabaseCatalogs) {
						toDatabaseCatalogs[i].SyncFieldsDuringCreateOrUpdate(ctx, fromDatabaseCatalogs[i])
					}
				}
				to.SetDatabaseCatalogs(ctx, toDatabaseCatalogs)
			}
		}
	}
}
	...
	if !from.DatabaseCatalogs.IsNull() && !from.DatabaseCatalogs.IsUnknown() {
		if toDatabaseCatalogs, ok := to.GetDatabaseCatalogs(ctx); ok {
			if fromDatabaseCatalogs, ok := from.GetDatabaseCatalogs(ctx); ok {
				for i := range toDatabaseCatalogs {
					if i < len(fromDatabaseCatalogs) {
						toDatabaseCatalogs[i].SyncFieldsDuringRead(ctx, fromDatabaseCatalogs[i])
					}
				}
				to.SetDatabaseCatalogs(ctx, toDatabaseCatalogs)
			}
...
func (to *ListDatabaseInstanceRolesResponse_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from ListDatabaseInstanceRolesResponse_SdkV2) {
	...
	if !from.DatabaseInstanceRoles.IsNull() && !from.DatabaseInstanceRoles.IsUnknown() {
		if toDatabaseInstanceRoles, ok := to.GetDatabaseInstanceRoles(ctx); ok {
			if fromDatabaseInstanceRoles, ok := from.GetDatabaseInstanceRoles(ctx); ok {
				// Recursively sync the fields of each DatabaseInstanceRoles element by position.
				for i := range toDatabaseInstanceRoles {
					if i < len(fromDatabaseInstanceRoles) {
						toDatabaseInstanceRoles[i].SyncFieldsDuringCreateOrUpdate(ctx, fromDatabaseInstanceRoles[i])
					}
				}
				to.SetDatabaseInstanceRoles(ctx, toDatabaseInstanceRoles)
			}
		}
	}
}
	...
	if !from.DatabaseInstanceRoles.IsNull() && !from.DatabaseInstanceRoles.IsUnknown() {
		if toDatabaseInstanceRoles, ok := to.GetDatabaseInstanceRoles(ctx); ok {
			if fromDatabaseInstanceRoles, ok := from.GetDatabaseInstanceRoles(ctx); ok {
				for i := range toDatabaseInstanceRoles {
					if i < len(fromDatabaseInstanceRoles) {
						toDatabaseInstanceRoles[i].SyncFieldsDuringRead(ctx, fromDatabaseInstanceRoles[i])
					}
				}
				to.SetDatabaseInstanceRoles(ctx, toDatabaseInstanceRoles)
			}
...
func (to *ListDatabaseInstancesResponse_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from ListDatabaseInstancesResponse_SdkV2) {
	...
	if !from.DatabaseInstances.IsNull() && !from.DatabaseInstances.IsUnknown() {
		if toDatabaseInstances, ok := to.GetDatabaseInstances(ctx); ok {
			if fromDatabaseInstances, ok := from.GetDatabaseInstances(ctx); ok {
				// Recursively sync the fields of each DatabaseInstances element by position.
				for i := range toDatabaseInstances {
					if i < len(fromDatabaseInstances) {
						toDatabaseInstances[i].SyncFieldsDuringCreateOrUpdate(ctx, fromDatabaseInstances[i])
					}
				}
				to.SetDatabaseInstances(ctx, toDatabaseInstances)
			}
		}
	}
}
	...
	if !from.DatabaseInstances.IsNull() && !from.DatabaseInstances.IsUnknown() {
		if toDatabaseInstances, ok := to.GetDatabaseInstances(ctx); ok {
			if fromDatabaseInstances, ok := from.GetDatabaseInstances(ctx); ok {
				for i := range toDatabaseInstances {
					if i < len(fromDatabaseInstances) {
						toDatabaseInstances[i].SyncFieldsDuringRead(ctx, fromDatabaseInstances[i])
					}
				}
				to.SetDatabaseInstances(ctx, toDatabaseInstances)
			}
...
func (to *ListSyncedDatabaseTablesResponse_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from ListSyncedDatabaseTablesResponse_SdkV2) {
	...
	if !from.SyncedTables.IsNull() && !from.SyncedTables.IsUnknown() {
		if toSyncedTables, ok := to.GetSyncedTables(ctx); ok {
			if fromSyncedTables, ok := from.GetSyncedTables(ctx); ok {
				// Recursively sync the fields of each SyncedTables element by position.
				for i := range toSyncedTables {
					if i < len(fromSyncedTables) {
						toSyncedTables[i].SyncFieldsDuringCreateOrUpdate(ctx, fromSyncedTables[i])
					}
				}
				to.SetSyncedTables(ctx, toSyncedTables)
			}
		}
	}
}
	...
	if !from.SyncedTables.IsNull() && !from.SyncedTables.IsUnknown() {
		if toSyncedTables, ok := to.GetSyncedTables(ctx); ok {
			if fromSyncedTables, ok := from.GetSyncedTables(ctx); ok {
				for i := range toSyncedTables {
					if i < len(fromSyncedTables) {
						toSyncedTables[i].SyncFieldsDuringRead(ctx, fromSyncedTables[i])
					}
				}
				to.SetSyncedTables(ctx, toSyncedTables)
			}
...
func (to *SyncedTableSpec_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from SyncedTableSpec_SdkV2) {
	if !from.AcceleratedSync.IsUnknown() && !from.AcceleratedSync.IsNull() {
		// AcceleratedSync is an input only field and not returned by the service, so we keep the value from the prior state.
		to.AcceleratedSync = from.AcceleratedSync
	}
...
func (m SyncedTableSpec_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	...
	attrs["accelerated_sync"] = attrs["accelerated_sync"].SetComputed()
	attrs["accelerated_sync"] = attrs["accelerated_sync"].(tfschema.BoolAttributeBuilder).AddPlanModifier(boolplanmodifier.UseStateForUnknown()).(tfschema.AttributeBuilder)
...
func (m SyncedTableSpec_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"type_overrides":      reflect.TypeOf(SyncedTableSpecTypeOverride_SdkV2{}),
	}
}
	...
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"type_overrides": basetypes.ListType{
				ElemType: SyncedTableSpecTypeOverride_SdkV2{}.Type(ctx),
			},
		},
	}
}
...
// GetTypeOverrides returns the value of the TypeOverrides field in SyncedTableSpec_SdkV2 as
// a slice of SyncedTableSpecTypeOverride_SdkV2 values.
// If the field is unknown or null, the boolean return value is false.
func (m *SyncedTableSpec_SdkV2) GetTypeOverrides(ctx context.Context) ([]SyncedTableSpecTypeOverride_SdkV2, bool) {
	if m.TypeOverrides.IsNull() || m.TypeOverrides.IsUnknown() {
		return nil, false
	}
	var v []SyncedTableSpecTypeOverride_SdkV2
...
// SetTypeOverrides sets the value of the TypeOverrides field in SyncedTableSpec_SdkV2.
func (m *SyncedTableSpec_SdkV2) SetTypeOverrides(ctx context.Context, v []SyncedTableSpecTypeOverride_SdkV2) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
type SyncedTableSpecTypeOverride_SdkV2 struct {
...
func (to *SyncedTableSpecTypeOverride_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from SyncedTableSpecTypeOverride_SdkV2) {
}

func (to *SyncedTableSpecTypeOverride_SdkV2) SyncFieldsDuringRead(ctx context.Context, from SyncedTableSpecTypeOverride_SdkV2) {
}

func (m SyncedTableSpecTypeOverride_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// GetComplexFieldTypes returns a map of the types of elements in complex fields in SyncedTableSpecTypeOverride.
// Container types (types.Map, types.List, types.Set) and object types (types.Object) do not carry
// the type information of their elements in the Go type system. This function provides a way to
// retrieve the type information of the elements in complex fields at runtime. The values of the map
// are the reflected types of the contained elements. They must be either primitive values from the
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m SyncedTableSpecTypeOverride_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, SyncedTableSpecTypeOverride_SdkV2
// only implements ToObjectValue() and Type().
func (m SyncedTableSpecTypeOverride_SdkV2) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m SyncedTableSpecTypeOverride_SdkV2) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
