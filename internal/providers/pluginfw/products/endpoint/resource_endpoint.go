...
func (m Endpoint) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		"aws_vpc_endpoint_info":       reflect.TypeOf(networking_tf.AwsVpcEndpointInfo{}),
		"azure_private_endpoint_info": reflect.TypeOf(networking_tf.AzurePrivateEndpointInfo{}),
		"gcp_psc_endpoint_info":       reflect.TypeOf(networking_tf.GcpPscEndpointInfo{}),
	}
}
...
func (m Endpoint) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{"account_id": types.StringType,
			"aws_vpc_endpoint_info":       networking_tf.AwsVpcEndpointInfo{}.Type(ctx),
			"azure_private_endpoint_info": networking_tf.AzurePrivateEndpointInfo{}.Type(ctx),
			"create_time":                 timetypes.RFC3339{}.Type(ctx),
			"display_name":                types.StringType,
			"endpoint_id":                 types.StringType,
			"gcp_psc_endpoint_info":       networking_tf.GcpPscEndpointInfo{}.Type(ctx),
...
// a networking_tf.AwsVpcEndpointInfo value.
// If the field is unknown or null, the boolean return value is false.
func (m *Endpoint) GetAwsVpcEndpointInfo(ctx context.Context) (networking_tf.AwsVpcEndpointInfo, bool) {
	var e networking_tf.AwsVpcEndpointInfo
	if m.AwsVpcEndpointInfo.IsNull() || m.AwsVpcEndpointInfo.IsUnknown() {
		return e, false
	}
	var v networking_tf.AwsVpcEndpointInfo
...
func (m *Endpoint) SetAwsVpcEndpointInfo(ctx context.Context, v networking_tf.AwsVpcEndpointInfo) {
...
// a networking_tf.GcpPscEndpointInfo value.
// If the field is unknown or null, the boolean return value is false.
func (m *Endpoint) GetGcpPscEndpointInfo(ctx context.Context) (networking_tf.GcpPscEndpointInfo, bool) {
	var e networking_tf.GcpPscEndpointInfo
	if m.GcpPscEndpointInfo.IsNull() || m.GcpPscEndpointInfo.IsUnknown() {
		return e, false
	}
	var v networking_tf.GcpPscEndpointInfo
...
func (m *Endpoint) SetGcpPscEndpointInfo(ctx context.Context, v networking_tf.GcpPscEndpointInfo) {
	vs := v.ToObjectValue(ctx)
