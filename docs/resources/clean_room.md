...
---
# databricks_clean_room Resource
# Clean Room Resource
...
```hcl
resource "databricks_clean_room" "this" {
    name = "claire-test-6-25-v2"
    owner = "claire.chen@databricks.com"
        ...
        collaborators = [
            {
                ...
                global_metastore_id = "aws:us-east-1:7746ae35-88c7-49e6-8965-2cc09882e727"
                invite_recipient_email: "claire.chen@databricks.com"
                invite_recipient_workspace_id = "653212377970039"
            },
            {
                global_metastore_id = "aws:us-east-1:7746ae35-88c7-49e6-8965-2cc09882e727"
...
import {
  id = name
  to = databricks_clean_room.this
}
```

If you are using an older version of Terraform, import the resource using the `terraform import` command as follows:
```sh
terraform import databricks_clean_room name
```