...
type DatabricksClient struct {
	...
	// Resource ID of the Azure Databricks application.
	// This is configured automatically when an Azure authentication method is used.
	armDatabricksResourceID string
