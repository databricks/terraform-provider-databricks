...
//					testScimUserResourceExists("db_scim_user.my_scim_user", &scimUser, t),
//					// verify remote values
//					testScimUserValues(t, &scimUser, userName, displayName),
//					// verify local values
//					resource.TestCheckResourceAttr("db_scim_user.my_scim_user", "user_name", userName),
//					resource.TestCheckResourceAttr("db_scim_user.my_scim_user", "display_name", displayName),
//					resource.TestCheckResourceAttr("db_scim_user.my_scim_user", "entitlements.#", "1"),
//				),
//			},
//		},
//	})
...
//	return fmt.Sprintf(`
//								resource "db_scim_user" "my_scim_user" {
//								  user_name = "%s"
//								  display_name = "%s"
//								  entitlements = [
