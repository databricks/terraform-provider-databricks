...
func TestAccGrant_ProviderConfig_Invalid(t *testing.T) {
...
func TestAccGrant_ProviderConfig_Required(t *testing.T) {
	acceptance.UnityWorkspaceLevel(t, acceptance.Step{
		Template: grantProviderConfigTemplate(`
			provider_config {
			}
...
func TestAccGrant_ProviderConfig_EmptyID(t *testing.T) {
	acceptance.UnityWorkspaceLevel(t, acceptance.Step{
		Template: grantProviderConfigTemplate(`
			provider_config {
				workspace_id = ""
...
func TestAccGrant_ProviderConfig_Mismatched(t *testing.T) {
	acceptance.UnityWorkspaceLevel(t, acceptance.Step{
		Template: grantProviderConfigTemplate(`
			provider_config {
				workspace_id = "123"
