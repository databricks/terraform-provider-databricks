...
func TestAccAzureSecretResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAzureSecretResourceDestroy,
		Steps: []resource.TestStep{
			{
				// use a dynamic configuration with the random name from above
				Config: testAzureSecretResource(scope, key, stringValue),
				// compose a basic test, checking both remote and local values
				Check: resource.ComposeTestCheckFunc(
					// query the API to retrieve the tokenInfo object
					testAzureSecretResourceExists("databricks_secret.my_secret", &secret, t),
					// verify remote values
					testAzureSecretValues(t, &secret, key),
					// verify local values
...
func testAzureSecretResourceDestroy(s *terraform.State) error {
	client := testAccProvider.Meta().(*service.DBApiClient)
...
func testAzureSecretValues(t *testing.T, secret *model.SecretMetadata, key string) resource.TestCheckFunc {
...
func testAzureSecretResourceExists(n string, secret *model.SecretMetadata, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAzureSecretResource(scopeName, key, value string) string {
	return fmt.Sprintf(`
