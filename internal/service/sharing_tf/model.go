...
type CreateShare struct {
	...
	ServerlessBudgetPolicyId types.String `tfsdk:"serverless_budget_policy_id"`
...
func (m CreateShare) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["comment"] = attrs["comment"].SetOptional()
	attrs["name"] = attrs["name"].SetRequired()
	attrs["serverless_budget_policy_id"] = attrs["serverless_budget_policy_id"].SetOptional()
...
func (m CreateShare) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		...
		map[string]attr.Value{
			"comment":                     m.Comment,
			"name":                        m.Name,
			"serverless_budget_policy_id": m.ServerlessBudgetPolicyId,
...
func (m CreateShare) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"comment":                     types.StringType,
			"name":                        types.StringType,
			"serverless_budget_policy_id": types.StringType,
