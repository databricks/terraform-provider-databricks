...
var (
	...
	baseJobDependencies = []reference{
		...
		{Path: "email_notifications.on_streaming_backlog_exceeded", Resource: "databricks_user",
			Match: "user_name", MatchType: MatchCaseInsensitive},
		{Path: "task.library.whl", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.new_cluster.init_scripts.workspace.destination", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.new_cluster.init_scripts.workspace.destination", Resource: "databricks_git_folder", Match: "path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.notebook_task.base_parameters", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.notebook_task.notebook_path", Resource: "databricks_git_folder", Match: "path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.notebook_task.notebook_path", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.python_wheel_task.named_parameters", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.python_wheel_task.parameters", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.run_job_task.job_parameters", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.spark_python_task.python_file", Resource: "databricks_git_folder", Match: "path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.spark_python_task.python_file", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.spark_jar_task.parameters", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "task.spark_submit_task.parameters", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "job_cluster.new_cluster.init_scripts.workspace.destination",
			Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
		{Path: "job_cluster.new_cluster.init_scripts.workspace.destination",
			Resource: "databricks_git_folder", Match: "path"},
		{Path: "parameter.default", Resource: "databricks_git_folder", Match: "workspace_path",
			MatchType: MatchPrefix, SearchValueTransformFunc: appendEndingSlashToDirName},
	}
)
