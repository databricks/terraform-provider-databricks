...
func (m *DatabaseInstanceRole) GetEffectiveAttributes(ctx context.Context) (DatabaseInstanceRoleAttributes, bool) {
	...
	var v DatabaseInstanceRoleAttributes
	d := m.EffectiveAttributes.As(ctx, &v, basetypes.ObjectAsOptions{
		UnhandledNullAsEmpty:    true,
		UnhandledUnknownAsEmpty: true,
	})
	if d.HasError() {
...
func (m SyncedTableSpec) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"type_overrides":      reflect.TypeOf(SyncedTableSpecTypeOverride{}),
	}
}
	...
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"type_overrides": basetypes.ListType{
				ElemType: SyncedTableSpecTypeOverride{}.Type(ctx),
			},
		},
	}
}
...
// GetTypeOverrides returns the value of the TypeOverrides field in SyncedTableSpec as
// a slice of SyncedTableSpecTypeOverride values.
// If the field is unknown or null, the boolean return value is false.
func (m *SyncedTableSpec) GetTypeOverrides(ctx context.Context) ([]SyncedTableSpecTypeOverride, bool) {
	if m.TypeOverrides.IsNull() || m.TypeOverrides.IsUnknown() {
		return nil, false
	}
	var v []SyncedTableSpecTypeOverride
...
// SetTypeOverrides sets the value of the TypeOverrides field in SyncedTableSpec.
func (m *SyncedTableSpec) SetTypeOverrides(ctx context.Context, v []SyncedTableSpecTypeOverride) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
func (to *SyncedTableSpecTypeOverride) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from SyncedTableSpecTypeOverride) {
}

func (to *SyncedTableSpecTypeOverride) SyncFieldsDuringRead(ctx context.Context, from SyncedTableSpecTypeOverride) {
}

func (m SyncedTableSpecTypeOverride) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m SyncedTableSpecTypeOverride) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, SyncedTableSpecTypeOverride
// only implements ToObjectValue() and Type().
func (m SyncedTableSpecTypeOverride) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m SyncedTableSpecTypeOverride) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
