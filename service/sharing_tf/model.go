...
func (tfSdkStruct *SecurablePropertiesMap) ToGoSdk(goSdkStruct sharing.SecurablePropertiesMap) error {
	return nil
}

func (tfSdkStruct *SecurablePropertiesMap) FromGoSdk(goSdkStruct sharing.SecurablePropertiesMap) error {
	return nil
}
