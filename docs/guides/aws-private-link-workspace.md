...
For a workspace to support any of the PrivateLink connectivity scenarios, the workspace must be created with an attached [private access settings object](../resources/mws_private_access_settings.md)
