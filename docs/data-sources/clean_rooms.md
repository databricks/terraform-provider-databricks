...
---
# databricks_clean_rooms Data Source
# Datasource (Plural) Artifact

A plural datasource artifact represents a collection of data sources that can be used within a Clean Room for secure data collaboration and analysis. 
...
```hcl
data "databricks_clean_rooms" "all" {}
```
