...
type EntityTagAssignmentsList struct {
	catalog_tf.ListEntityTagAssignmentsRequest
	EntityTagAssignments types.List `tfsdk:"tag_assignments"`
}

func (c EntityTagAssignmentsList) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["tag_assignments"] = attrs["tag_assignments"].SetComputed()
	return attrs
}

func (EntityTagAssignmentsList) GetComplexFieldTypes(context.Context) map[string]reflect.Type {
...
func (r *EntityTagAssignmentsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	attrs, blocks := tfschema.DataSourceStructToSchemaMap(ctx, EntityTagAssignmentsList{}, nil)
...
func (r *EntityTagAssignmentsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var config EntityTagAssignmentsList
	...
	var newState EntityTagAssignmentsList
