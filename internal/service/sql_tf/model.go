...
func (to *AlertStatementParameter) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from AlertStatementParameter) {
}

func (to *AlertStatementParameter) SyncFieldsDuringRead(ctx context.Context, from AlertStatementParameter) {
}

func (m AlertStatementParameter) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m AlertStatementParameter) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, AlertStatementParameter
// only implements ToObjectValue() and Type().
func (m AlertStatementParameter) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"name":  m.Name,
...
// Type implements basetypes.ObjectValuable.
func (m AlertStatementParameter) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"name":  types.StringType,
...
func (m AlertV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"parameters":       reflect.TypeOf(AlertStatementParameter{}),
	...
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"parameters": basetypes.SetType{
				ElemType: AlertStatementParameter{}.Type(ctx),
			},
			"parent_path":      types.StringType,
...
// a slice of AlertStatementParameter values.
// If the field is unknown or null, the boolean return value is false.
func (m *AlertV2) GetParameters(ctx context.Context) ([]AlertStatementParameter, bool) {
	if m.Parameters.IsNull() || m.Parameters.IsUnknown() {
		return nil, false
	}
	var v []AlertStatementParameter
...
func (m *AlertV2) SetParameters(ctx context.Context, v []AlertStatementParameter) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
...
func (m ExecuteStatementRequest) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"query_tags": reflect.TypeOf(QueryTag{}),
	}
}
...
// GetQueryTags returns the value of the QueryTags field in ExecuteStatementRequest as
// a slice of QueryTag values.
// If the field is unknown or null, the boolean return value is false.
func (m *ExecuteStatementRequest) GetQueryTags(ctx context.Context) ([]QueryTag, bool) {
...
// SetQueryTags sets the value of the QueryTags field in ExecuteStatementRequest.
func (m *ExecuteStatementRequest) SetQueryTags(ctx context.Context, v []QueryTag) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
// GetQueryTags returns the value of the QueryTags field in QueryInfo as
// a slice of QueryTag values.
// If the field is unknown or null, the boolean return value is false.
func (m *QueryInfo) GetQueryTags(ctx context.Context) ([]QueryTag, bool) {
	if m.QueryTags.IsNull() || m.QueryTags.IsUnknown() {
		return nil, false
	}
	var v []QueryTag
...
// SetQueryTags sets the value of the QueryTags field in QueryInfo.
func (m *QueryInfo) SetQueryTags(ctx context.Context, v []QueryTag) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
func (to *QueryTag) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from QueryTag) {
}

func (to *QueryTag) SyncFieldsDuringRead(ctx context.Context, from QueryTag) {
}

func (m QueryTag) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m QueryTag) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, QueryTag
// only implements ToObjectValue() and Type().
func (m QueryTag) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"key":   m.Key,
...
// Type implements basetypes.ObjectValuable.
func (m QueryTag) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"key":   types.StringType,
			"value": types.StringType,
