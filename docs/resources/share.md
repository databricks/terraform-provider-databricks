...
* `name` (Required) - Full name of the object, e.g. `catalog.schema.name` for a tables, volumes and models, or `catalog.schema` for schemas. Change forces creation of a new resource.
