...
# If a Markdown report path was provided (CI sets this for the sticky-comment step),
# write the report there as well. --allow-breaking on this invocation so the
# exit code we already captured above is the one that matters.
