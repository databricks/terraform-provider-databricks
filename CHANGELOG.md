 ...
 * Ignoreed delete permission error for manually removed [databricks_job](https://registry.terraform.io/providers/databricks/databricks/latest/docs/resources/job) ([#2225](https://github.com/databricks/terraform-provider-databricks/pull/2225)).
 * Removed a note about Azure KeyVault and Service Principal from [databricks_secret_scope](https://registry.terraform.io/providers/databricks/databricks/latest/docs/resources/secret_scope) troubleshooting guide ([#2248](https://github.com/databricks/terraform-provider-databricks/pull/2248)).
 ...
 * Updated [databricks_sql_endpoint](https://registry.terraform.io/providers/databricks/databricks/latest/docs/resources/sql_endpoint) docs for Azure DBSQL Serverless GA ([#2249], [#2254](https://github.com/databricks/terraform-provider-databricks/pull/2254)).
 ...
 * Added a note about Azure Databricks workspaces creation ([#2228](https://github.com/databricks/terraform-provider-databricks/pull/2228)).
 * Added example for for [databricks_job](https://registry.terraform.io/providers/databricks/databricks/latest/docs/resources/job) tags ([#2235](https://github.com/databricks/terraform-provider-databricks/pull/2235)).
