...
func (r *ClusterResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes:  tfschema.ResourceStructToSchemaMap(ClusterSpec{}, nil),
	}
}
...
func (r *ClusterResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	_, diags := r.Client.GetWorkspaceClient()
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var monitorInfoTfSDK ClusterSpec
...
func (r *ClusterResource) Read(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	_, diags := r.Client.GetWorkspaceClient()
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
...
func (r *ClusterResource) Update(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	_, diags := r.Client.GetWorkspaceClient()
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
...
func (r *ClusterResource) Delete(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	_, diags := r.Client.GetWorkspaceClient()
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
...
type LibraryWithAlias struct {
	Libraries []compute_tf.Library `json:"libraries,omitempty" tf:"slice_set,alias:library"`
}
...
func init() {
	common.RegisterResourceProvider(compute_tf.ClusterSpec{}, ClusterSpec{})
	common.RegisterResourceProvider(compute_tf.Library{}, LibraryResource{})
}
