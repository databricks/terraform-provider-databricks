...
func TestMwsAccAccountServicePrincipalRuleSetsFullLifeCycle(t *testing.T) {
	...
	acceptance.AccountLevel(t, acceptance.Step{
		...
		Check: acceptance.ResourceCheckWithState("databricks_access_control_rule_set.sp_rule_set",
...
func TestMwsAccAccountGroupRuleSetsFullLifeCycle(t *testing.T) {
	...
	acceptance.AccountLevel(t, acceptance.Step{
		...
		Check: acceptance.ResourceCheck("databricks_access_control_rule_set.group_rule_set",
