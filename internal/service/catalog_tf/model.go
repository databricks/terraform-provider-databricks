...
type OnlineTable struct {
	...
	TableServingUrl          types.String `tfsdk:"table_serving_url" tf:"optional,computed"`
	_OriginalTableServingUrl types.String `tfsdk:"table_serving_url" tf:"optional,computed"`
}
...
type OnlineTableSpec struct {
	...
	// the caller.
	PipelineId          types.String `tfsdk:"pipeline_id" tf:"optional,computed"`
	_OriginalPipelineId types.String `tfsdk:"pipeline_id" tf:"optional,computed"`
