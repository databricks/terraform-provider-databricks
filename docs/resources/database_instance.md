...
This resource supports resource behavior fields. These can be accessed through the `resource_behavior` attribute. 
The following fields are supported:
* `force_destroy` (boolean, optional) - Force the resource to be destroyed
* `purge_on_destroy` (boolean, optional) - Purge the resource on destroy
