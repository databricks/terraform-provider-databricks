...
This data source can be used to list all tag policies in the account. Manage tag policy permissions using the `databricks_access_control_rule_set` resource.
