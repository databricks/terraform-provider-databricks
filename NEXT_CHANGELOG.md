...
* Prevent repeated diffs for `databricks_mws_private_access_settings.allowed_vpc_endpoint_ids` when the Accounts API returns the same IDs in a different order ([#0000](https://github.com/databricks/terraform-provider-databricks/pull/0000)).
