...
type Alert struct {
	...
	LastTriggeredAt string `tfsdk:"last_triggered_at"`
	// Name of the alert.
...
type AlertOptions struct {
	...
	Column string `tfsdk:"column"`
	// Custom body of alert notification, if it exists. See [here] for custom
	// templating instructions.
	//
	// [here]: https://docs.databricks.com/sql/user/alerts/index.html
	CustomBody string `tfsdk:"custom_body"`
...
type AlertQuery struct {
	...
	DataSourceId string `tfsdk:"data_source_id"`
	...
	IsArchived bool `tfsdk:"is_archived"`
	// Whether the query is a draft. Draft queries only appear in list views for
	// their owners. Visualizations from draft queries cannot appear on
	// dashboards.
	IsDraft bool `tfsdk:"is_draft"`
...
type BaseChunkInfo struct {
	...
	ByteCount int64 `tfsdk:"byte_count"`
	// The position within the sequence of result set chunks.
	ChunkIndex int `tfsdk:"chunk_index"`
	// The number of rows within the result chunk.
	RowCount int64 `tfsdk:"row_count"`
	// The starting row offset within the result set.
	RowOffset int64 `tfsdk:"row_offset"`
...
type Channel struct {
	DbsqlVersion string `tfsdk:"dbsql_version"`
...
type CreateWarehouseRequest struct {
	...
	AutoStopMins int `tfsdk:"auto_stop_mins"`
	// Channel Details
	...
	ClusterSize string `tfsdk:"cluster_size"`
	// warehouse creator name
	CreatorName string `tfsdk:"creator_name"`
	// Configures whether the warehouse should use Photon optimized clusters.
	//
	// Defaults to false.
	EnablePhoton bool `tfsdk:"enable_photon"`
	// Configures whether the warehouse should use serverless compute
	EnableServerlessCompute bool `tfsdk:"enable_serverless_compute"`
	...
	MaxNumClusters int `tfsdk:"max_num_clusters"`
	...
	//
	// Defaults to 1
	MinNumClusters int `tfsdk:"min_num_clusters"`
...
type CreateWidget struct {
	...
	VisualizationId string `tfsdk:"visualization_id"`
	// Width of a widget
	Width int `tfsdk:"width"`
...
type Dashboard struct {
	...
	CanEdit bool `tfsdk:"can_edit"`
	// Timestamp when this dashboard was created.
	CreatedAt string `tfsdk:"created_at"`
	// In the web application, query filters that share a name are coupled to a
	// single selection box if this value is `true`.
	DashboardFiltersEnabled bool `tfsdk:"dashboard_filters_enabled"`
	...
	// is selected.
	IsFavorite bool `tfsdk:"is_favorite"`
...
type DashboardOptions struct {
	...
	// thirty days.
	MovedToTrashAt string `tfsdk:"moved_to_trash_at"`
...
type DataSource struct {
	...
	PauseReason string `tfsdk:"pause_reason"`
	// Reserved for internal use.
	Paused int `tfsdk:"paused"`
	// Reserved for internal use.
	SupportsAutoLimit bool `tfsdk:"supports_auto_limit"`
	// Reserved for internal use.
...
type EndpointInfo struct {
	...
	NumActiveSessions int64 `tfsdk:"num_active_sessions"`
	// current number of clusters running for the service
	NumClusters int `tfsdk:"num_clusters"`
...
type ExecuteStatementRequest struct {
	...
	ByteLimit int64 `tfsdk:"byte_limit"`
	...
	RowLimit int64 `tfsdk:"row_limit"`
	...
	Statement string `tfsdk:"statement"`
	...
	WaitTimeout string `tfsdk:"wait_timeout"`
...
type ExecuteStatementResponse struct {
	...
	// The statement ID is returned upon successfully submitting a SQL
	// statement, and is a required reference for all subsequent calls.
	StatementId string `tfsdk:"statement_id"`
...
type ExternalLink struct {
	...
	ExternalLink string `tfsdk:"external_link"`
	...
	HttpHeaders map[string]string `tfsdk:"http_headers"`
	...
	NextChunkIndex int `tfsdk:"next_chunk_index"`
	...
	NextChunkInternalLink string `tfsdk:"next_chunk_internal_link"`
	// The number of rows within the result chunk.
	RowCount int64 `tfsdk:"row_count"`
	// The starting row offset within the result set.
	RowOffset int64 `tfsdk:"row_offset"`
...
type ListDashboardsRequest struct {
	...
	Page int `tfsdk:"-" url:"page,omitempty"`
	// Number of dashboards to return per page.
	PageSize int `tfsdk:"-" url:"page_size,omitempty"`
	// Full text search term.
	Q string `tfsdk:"-" url:"q,omitempty"`
...
type ListQueriesRequest struct {
	...
	Order string `tfsdk:"-" url:"order,omitempty"`
	// Page number to retrieve.
	Page int `tfsdk:"-" url:"page,omitempty"`
...
type ListQueriesResponse struct {
	...
	HasNextPage bool `tfsdk:"has_next_page"`
...
type ListQueryHistoryRequest struct {
	...
	IncludeMetrics bool `tfsdk:"-" url:"include_metrics,omitempty"`
...
type ListWarehousesRequest struct {
	...
	RunAsUserId int `tfsdk:"-" url:"run_as_user_id,omitempty"`
...
type MultiValuesOptions struct {
	...
	// comma.
	Separator string `tfsdk:"separator"`
...
type Parameter struct {
	...
	EnumOptions string `tfsdk:"enumOptions"`
...
type Query struct {
	...
	LastModifiedById int `tfsdk:"last_modified_by_id"`
	// If there is a cached result for this query and user, this field includes
	// the query result ID. If this query uses parameters, this field is always
	// null.
	LatestQueryDataId string `tfsdk:"latest_query_data_id"`
	// The title of this query that appears in list views, widget headings, and
	// on the query page.
	Name string `tfsdk:"name"`
	...
	QueryHash string `tfsdk:"query_hash"`
	// Sets the **Run as** role for the object. Must be set to one of `"viewer"`
	// (signifying "run as viewer" behavior) or `"owner"` (signifying "run as
	// owner" behavior)
	RunAsRole RunAsRole `tfsdk:"run_as_role"`
...
type QueryFilter struct {
	...
	StatementIds []string `tfsdk:"statement_ids" url:"statement_ids,omitempty"`

	Statuses []QueryStatus `tfsdk:"statuses" url:"statuses,omitempty"`
	// A list of user IDs who ran the queries.
	UserIds []int `tfsdk:"user_ids" url:"user_ids,omitempty"`
	// A list of warehouse IDs.
	WarehouseIds []string `tfsdk:"warehouse_ids" url:"warehouse_ids,omitempty"`
}

type QueryInfo struct {
	// Reserved for internal use.
	CanSubscribeToLiveQuery bool `tfsdk:"canSubscribeToLiveQuery"`
	// Channel information for the SQL warehouse at the time of query execution
	ChannelUsed *ChannelInfo `tfsdk:"channel_used"`
	// Total execution time of the statement ( excluding result fetch time ).
	Duration int `tfsdk:"duration"`
	// Alias for `warehouse_id`.
	EndpointId string `tfsdk:"endpoint_id"`
	// Message describing why the query could not complete.
	ErrorMessage string `tfsdk:"error_message"`
	// The ID of the user whose credentials were used to run the query.
	ExecutedAsUserId int `tfsdk:"executed_as_user_id"`
	// The email address or username of the user whose credentials were used to
	// run the query.
	ExecutedAsUserName string `tfsdk:"executed_as_user_name"`
	// The time execution of the query ended.
	ExecutionEndTimeMs int `tfsdk:"execution_end_time_ms"`
	// Whether more updates for the query are expected.
	IsFinal bool `tfsdk:"is_final"`
	...
	QueryEndTimeMs int `tfsdk:"query_end_time_ms"`
	// The query ID.
	QueryId string `tfsdk:"query_id"`
	// The time the query started.
	QueryStartTimeMs int `tfsdk:"query_start_time_ms"`
	// The text of the query.
	QueryText string `tfsdk:"query_text"`
	// The number of results returned by the query.
	RowsProduced int `tfsdk:"rows_produced"`
	// URL to the query plan.
	SparkUiUrl string `tfsdk:"spark_ui_url"`
...
type QueryMetrics struct {
	...
	CompilationTimeMs int `tfsdk:"compilation_time_ms"`
	// Time spent executing the query, in milliseconds.
	ExecutionTimeMs int `tfsdk:"execution_time_ms"`
	// Reserved for internal use.
	MetadataTimeMs int `tfsdk:"metadata_time_ms"`
	// Total amount of data sent over the network between executor nodes during
	// shuffle, in bytes.
	NetworkSentBytes int `tfsdk:"network_sent_bytes"`
	...
	OverloadingQueueStartTimestamp int `tfsdk:"overloading_queue_start_timestamp"`
	// Total execution time for all individual Photon query engine tasks in the
	// query, in milliseconds.
	PhotonTotalTimeMs int `tfsdk:"photon_total_time_ms"`
	// Reserved for internal use.
	PlanningTimeMs int `tfsdk:"planning_time_ms"`
	...
	ProvisioningQueueStartTimestamp int `tfsdk:"provisioning_queue_start_timestamp"`
	// Total number of bytes in all tables not read due to pruning
	PrunedBytes int `tfsdk:"pruned_bytes"`
	// Total number of files from all tables not read due to pruning
	PrunedFilesCount int `tfsdk:"pruned_files_count"`
	// Timestamp of when the underlying compute started compilation of the
	// query.
	QueryCompilationStartTimestamp int `tfsdk:"query_compilation_start_timestamp"`
	// Reserved for internal use.
	QueryExecutionTimeMs int `tfsdk:"query_execution_time_ms"`
	// Total size of data read by the query, in bytes.
	ReadBytes int `tfsdk:"read_bytes"`
	// Size of persistent data read from the cache, in bytes.
	ReadCacheBytes int `tfsdk:"read_cache_bytes"`
	// Number of files read after pruning.
	ReadFilesCount int `tfsdk:"read_files_count"`
	// Number of partitions read after pruning.
	ReadPartitionsCount int `tfsdk:"read_partitions_count"`
	// Size of persistent data read from cloud object storage on your cloud
	// tenant, in bytes.
	ReadRemoteBytes int `tfsdk:"read_remote_bytes"`
	// Time spent fetching the query results after the execution finished, in
	// milliseconds.
	ResultFetchTimeMs int `tfsdk:"result_fetch_time_ms"`
	// true if the query result was fetched from cache, false otherwise.
	ResultFromCache bool `tfsdk:"result_from_cache"`
	// Total number of rows returned by the query.
	RowsProducedCount int `tfsdk:"rows_produced_count"`
	// Total number of rows read by the query.
	RowsReadCount int `tfsdk:"rows_read_count"`
	// Size of data temporarily written to disk while executing the query, in
	// bytes.
	SpillToDiskBytes int `tfsdk:"spill_to_disk_bytes"`
	// Sum of execution time for all of the query’s tasks, in milliseconds.
	TaskTotalTimeMs int `tfsdk:"task_total_time_ms"`
	// Total execution time of the query from the client’s point of view, in
	// milliseconds.
	TotalTimeMs int `tfsdk:"total_time_ms"`
	// Size pf persistent data written to cloud object storage in your cloud
	// tenant, in bytes.
	WriteRemoteBytes int `tfsdk:"write_remote_bytes"`
...
type ResultManifest struct {
	...
	TotalByteCount int64 `tfsdk:"total_byte_count"`
	// The total number of chunks that the result set has been divided into.
	TotalChunkCount int `tfsdk:"total_chunk_count"`
...
type TimeRange struct {
	...
	EndTimeMs int `tfsdk:"end_time_ms" url:"end_time_ms,omitempty"`
	// Limit results to queries that started after this time.
	StartTimeMs int `tfsdk:"start_time_ms" url:"start_time_ms,omitempty"`
...
type TransferOwnershipObjectId struct {
	...
	NewOwner string `tfsdk:"new_owner"`
...
type WidgetPosition struct {
	// reserved for internal use
	AutoHeight bool `tfsdk:"autoHeight"`
	// column in the dashboard grid. Values start with 0
	Col int `tfsdk:"col"`
	// row in the dashboard grid. Values start with 0
	Row int `tfsdk:"row"`
	// width of the widget measured in dashboard grid cells
	SizeX int `tfsdk:"sizeX"`
	// height of the widget measured in dashboard grid cells
	SizeY int `tfsdk:"sizeY"`
