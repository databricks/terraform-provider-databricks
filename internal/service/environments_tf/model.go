...
func (to *EnvironmentSpec) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from EnvironmentSpec) {
...
func (to *EnvironmentSpec) SyncFieldsDuringRead(ctx context.Context, from EnvironmentSpec) {
	if !from.Dependencies.IsNull() && !from.Dependencies.IsUnknown() && to.Dependencies.IsNull() && len(from.Dependencies.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for Dependencies, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (m EnvironmentSpec) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m EnvironmentSpec) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
...
// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, EnvironmentSpec
// only implements ToObjectValue() and Type().
func (m EnvironmentSpec) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m EnvironmentSpec) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
...
// GetDependencies returns the value of the Dependencies field in EnvironmentSpec as
// a slice of types.String values.
// If the field is unknown or null, the boolean return value is false.
func (m *EnvironmentSpec) GetDependencies(ctx context.Context) ([]types.String, bool) {
...
// SetDependencies sets the value of the Dependencies field in EnvironmentSpec.
func (m *EnvironmentSpec) SetDependencies(ctx context.Context, v []types.String) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e)
	}
...
func (m WorkspaceBaseEnvironment) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		"spec": reflect.TypeOf(EnvironmentSpec{}),
	}
}
...
// a EnvironmentSpec value.
// If the field is unknown or null, the boolean return value is false.
func (m *WorkspaceBaseEnvironment) GetSpec(ctx context.Context) (EnvironmentSpec, bool) {
	var e EnvironmentSpec
	if m.Spec.IsNull() || m.Spec.IsUnknown() {
		return e, false
	}
	var v EnvironmentSpec
...
func (m *WorkspaceBaseEnvironment) SetSpec(ctx context.Context, v EnvironmentSpec) {
	vs := v.ToObjectValue(ctx)
	m.Spec = vs
}
