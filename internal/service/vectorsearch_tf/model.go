...
func (to *UpdateVectorIndexUsagePolicyRequest) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from UpdateVectorIndexUsagePolicyRequest) {
}

func (to *UpdateVectorIndexUsagePolicyRequest) SyncFieldsDuringRead(ctx context.Context, from UpdateVectorIndexUsagePolicyRequest) {
}

func (m UpdateVectorIndexUsagePolicyRequest) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	attrs["index_name"] = attrs["index_name"].SetRequired()
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m UpdateVectorIndexUsagePolicyRequest) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, UpdateVectorIndexUsagePolicyRequest
// only implements ToObjectValue() and Type().
func (m UpdateVectorIndexUsagePolicyRequest) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
			"index_name": m.IndexName,
...
// Type implements basetypes.ObjectValuable.
func (m UpdateVectorIndexUsagePolicyRequest) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"index_name": types.StringType,
		},
...
func (to *UpdateVectorIndexUsagePolicyResponse) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from UpdateVectorIndexUsagePolicyResponse) {
}

func (to *UpdateVectorIndexUsagePolicyResponse) SyncFieldsDuringRead(ctx context.Context, from UpdateVectorIndexUsagePolicyResponse) {
}

func (m UpdateVectorIndexUsagePolicyResponse) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m UpdateVectorIndexUsagePolicyResponse) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, UpdateVectorIndexUsagePolicyResponse
// only implements ToObjectValue() and Type().
func (m UpdateVectorIndexUsagePolicyResponse) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{})
}
...
// Type implements basetypes.ObjectValuable.
func (m UpdateVectorIndexUsagePolicyResponse) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{},
	}
}
