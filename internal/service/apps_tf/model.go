...
type App struct {
	...
	DefaultGitSource types.Object `tfsdk:"default_git_source"`
...
func (m App) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
	...
	attrs["git_source"] = attrs["git_source"].(tfschema.SingleNestedAttributeBuilder).AddPlanModifier(objectplanmodifier.UseStateForUnknown()).(tfschema.AttributeBuilder)
...
func (m App) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"default_git_source":            reflect.TypeOf(GitSource{}),
		...
		"telemetry_export_destinations": reflect.TypeOf(TelemetryExportDestination{}),
...
func (m App) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"default_git_source":         GitSource{}.Type(ctx),
...
// GetDefaultGitSource returns the value of the DefaultGitSource field in App as
// a GitSource value.
// If the field is unknown or null, the boolean return value is false.
func (m *App) GetDefaultGitSource(ctx context.Context) (GitSource, bool) {
	var e GitSource
	if m.DefaultGitSource.IsNull() || m.DefaultGitSource.IsUnknown() {
		return e, false
	}
	var v GitSource
	d := m.DefaultGitSource.As(ctx, &v, basetypes.ObjectAsOptions{
		UnhandledNullAsEmpty:    true,
		UnhandledUnknownAsEmpty: true,
	})
	if d.HasError() {
...
// SetDefaultGitSource sets the value of the DefaultGitSource field in App.
func (m *App) SetDefaultGitSource(ctx context.Context, v GitSource) {
	vs := v.ToObjectValue(ctx)
	m.DefaultGitSource = vs
}
...
// GetGitSource returns the value of the GitSource field in App as
// a GitSource value.
// If the field is unknown or null, the boolean return value is false.
func (m *App) GetGitSource(ctx context.Context) (GitSource, bool) {
	var e GitSource
...
// SetGitSource sets the value of the GitSource field in App.
func (m *App) SetGitSource(ctx context.Context, v GitSource) {
	vs := v.ToObjectValue(ctx)
	m.GitSource = vs
}
...
// GetTelemetryExportDestinations returns the value of the TelemetryExportDestinations field in App as
// a slice of TelemetryExportDestination values.
// If the field is unknown or null, the boolean return value is false.
func (m *App) GetTelemetryExportDestinations(ctx context.Context) ([]TelemetryExportDestination, bool) {
	...
	var v []TelemetryExportDestination
...
// GetTelemetryExportDestinations returns the value of the TelemetryExportDestinations field in AppUpdate as
// a slice of TelemetryExportDestination values.
// If the field is unknown or null, the boolean return value is false.
func (m *AppUpdate) GetTelemetryExportDestinations(ctx context.Context) ([]TelemetryExportDestination, bool) {
	if m.TelemetryExportDestinations.IsNull() || m.TelemetryExportDestinations.IsUnknown() {
		return nil, false
	}
	var v []TelemetryExportDestination
...
// SetTelemetryExportDestinations sets the value of the TelemetryExportDestinations field in AppUpdate.
func (m *AppUpdate) SetTelemetryExportDestinations(ctx context.Context, v []TelemetryExportDestination) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e.ToObjectValue(ctx))
	}
...
func (m TelemetryExportDestination) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		"unity_catalog": reflect.TypeOf(UnityCatalog{}),
	}
}

// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, TelemetryExportDestination
// only implements ToObjectValue() and Type().
func (m TelemetryExportDestination) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m TelemetryExportDestination) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			"unity_catalog": UnityCatalog{}.Type(ctx),
		},
	}
}

// GetUnityCatalog returns the value of the UnityCatalog field in TelemetryExportDestination as
// a UnityCatalog value.
// If the field is unknown or null, the boolean return value is false.
func (m *TelemetryExportDestination) GetUnityCatalog(ctx context.Context) (UnityCatalog, bool) {
	...
	var v UnityCatalog
	d := m.UnityCatalog.As(ctx, &v, basetypes.ObjectAsOptions{
		UnhandledNullAsEmpty:    true,
		UnhandledUnknownAsEmpty: true,
	})
	if d.HasError() {
...
// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, UnityCatalog
// only implements ToObjectValue() and Type().
