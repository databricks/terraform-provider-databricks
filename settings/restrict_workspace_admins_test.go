...
func TestAccRestrictWorkspaceAdminsSetting(t *testing.T) {
	...
	acceptance.UnityWorkspaceLevel(t, acceptance.Step{
		Template: template,
		Check: acceptance.ResourceCheckWithState("databricks_restrict_workspace_admins_setting.this",
		...
		acceptance.Step{
			Template: template,
			Destroy:  true,
			Check: acceptance.ResourceCheck("databricks_restrict_workspace_admins_setting.this",
