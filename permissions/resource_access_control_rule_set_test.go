...
func TestResourceRuleSetRead_ApiFieldAccount(t *testing.T) {
	accountRuleSetApiPath := fmt.Sprintf("/api/2.0/preview/accounts/%s/access-control/rule-sets", testAccountId)
	qa.ResourceFixture{
		Fixtures: []qa.HTTPFixture{
			{
...
func TestResourceRuleSetCreate_ApiFieldAccount(t *testing.T) {
	accountRuleSetApiPath := fmt.Sprintf("/api/2.0/preview/accounts/%s/access-control/rule-sets", testAccountId)
	qa.ResourceFixture{
		Fixtures: []qa.HTTPFixture{
			{
...
func TestResourceRuleSetRead_ApiFieldWorkspace(t *testing.T) {
	qa.ResourceFixture{
		Fixtures: []qa.HTTPFixture{
			{
				Method:   "GET",
