...
---
# databricks_clean_room_assets_clean_room_assets Data Source
...
```hcl
resource "databricks_clean_room_assets_clean_room_asset" "all" {
}
```
...
## Attributes
This data source exports a single attribute, `assets`. It is a list of resources, each with the following attributes:
