...
type EnvironmentSpec_SdkV2 struct {
...
func (to *EnvironmentSpec_SdkV2) SyncFieldsDuringCreateOrUpdate(ctx context.Context, from EnvironmentSpec_SdkV2) {
...
func (to *EnvironmentSpec_SdkV2) SyncFieldsDuringRead(ctx context.Context, from EnvironmentSpec_SdkV2) {
	if !from.Dependencies.IsNull() && !from.Dependencies.IsUnknown() && to.Dependencies.IsNull() && len(from.Dependencies.Elements()) == 0 {
		// The default representation of an empty list for TF autogenerated resources in the resource state is Null.
		// If a user specified a non-Null, empty list for Dependencies, and the deserialized field value is Null,
		// set the resulting resource state to the empty list to match the planned value.
...
func (m EnvironmentSpec_SdkV2) ApplySchemaCustomizations(attrs map[string]tfschema.AttributeBuilder) map[string]tfschema.AttributeBuilder {
...
// GetComplexFieldTypes returns a map of the types of elements in complex fields in EnvironmentSpec.
// Container types (types.Map, types.List, types.Set) and object types (types.Object) do not carry
// the type information of their elements in the Go type system. This function provides a way to
// retrieve the type information of the elements in complex fields at runtime. The values of the map
// are the reflected types of the contained elements. They must be either primitive values from the
// plugin framework type system (types.String{}, types.Bool{}, types.Int64{}, types.Float64{}) or TF
// SDK values.
func (m EnvironmentSpec_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
...
// TFSDK types cannot implement the ObjectValuable interface directly, as it would otherwise
// interfere with how the plugin framework retrieves and sets values in state. Thus, EnvironmentSpec_SdkV2
// only implements ToObjectValue() and Type().
func (m EnvironmentSpec_SdkV2) ToObjectValue(ctx context.Context) basetypes.ObjectValue {
	return types.ObjectValueMust(
		m.Type(ctx).(basetypes.ObjectType).AttrTypes,
		map[string]attr.Value{
...
// Type implements basetypes.ObjectValuable.
func (m EnvironmentSpec_SdkV2) Type(ctx context.Context) attr.Type {
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
...
// GetDependencies returns the value of the Dependencies field in EnvironmentSpec_SdkV2 as
// a slice of types.String values.
// If the field is unknown or null, the boolean return value is false.
func (m *EnvironmentSpec_SdkV2) GetDependencies(ctx context.Context) ([]types.String, bool) {
...
// SetDependencies sets the value of the Dependencies field in EnvironmentSpec_SdkV2.
func (m *EnvironmentSpec_SdkV2) SetDependencies(ctx context.Context, v []types.String) {
	vs := make([]attr.Value, 0, len(v))
	for _, e := range v {
		vs = append(vs, e)
	}
...
func (m WorkspaceBaseEnvironment_SdkV2) GetComplexFieldTypes(ctx context.Context) map[string]reflect.Type {
	return map[string]reflect.Type{
		"spec": reflect.TypeOf(EnvironmentSpec_SdkV2{}),
	}
}
	...
	return types.ObjectType{
		AttrTypes: map[string]attr.Type{
			...
			"spec": basetypes.ListType{
				ElemType: EnvironmentSpec_SdkV2{}.Type(ctx),
			},
...
// GetSpec returns the value of the Spec field in WorkspaceBaseEnvironment_SdkV2 as
// a EnvironmentSpec_SdkV2 value.
// If the field is unknown or null, the boolean return value is false.
func (m *WorkspaceBaseEnvironment_SdkV2) GetSpec(ctx context.Context) (EnvironmentSpec_SdkV2, bool) {
	var e EnvironmentSpec_SdkV2
	if m.Spec.IsNull() || m.Spec.IsUnknown() {
		return e, false
	}
	var v []EnvironmentSpec_SdkV2
...
// SetSpec sets the value of the Spec field in WorkspaceBaseEnvironment_SdkV2.
func (m *WorkspaceBaseEnvironment_SdkV2) SetSpec(ctx context.Context, v EnvironmentSpec_SdkV2) {
	vs := []attr.Value{v.ToObjectValue(ctx)}
